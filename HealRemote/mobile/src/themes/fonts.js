/*
    File: fonts.js
    This file stores all of the global fonts and font sizes that will be used throughout
    the HealBeirut application. 
*/

import Metrics from './metrics';

// Standard Sizes for now, can be updated to fit our needs later
const size = {
